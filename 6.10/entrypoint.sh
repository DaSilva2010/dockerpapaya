...
sed "s/ext:\/\/username:password@host\/database/mysql:\/\/$PAPAYA_DB_USER:$PAPAYA_DB_PASSWORD@mysql\/$PAPAYA_DB_NAME/g" /var/www/papayacms-core-${PAPAYA_VERSION}/dist.build.properties > build.properties
php /var/www/phing.phar
